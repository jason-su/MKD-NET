...
class SystemConfig(object):
    def __init__(self):
        ...
        self._configs["decay_rate"]        = 5
        self._configs["max_iter"]          = 150000
        self._configs["val_iter"]          = 20
        self._configs["batch_size"]        = 12
        ...
        self._configs["train_tag"] = "merge-class-voc-1123"
#         self._configs["train_tag"] = "merge-class-voc-1108"
#         self._configs["train_tag"] = "merge-class-voc-1117"
    ...
    @property
    def result_dir(self):
        result_dir = os.path.join(self._configs["result_dir"],self._configs["train_tag"], self.snapshot_name)
    ...
    def snapshot_dir(self):
        snapshot_dir = os.path.join(self.cache_dir,self._configs["train_tag"], self.snapshot_name)
